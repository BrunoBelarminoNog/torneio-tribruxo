...
class Background extends Component {
  ...
  componentDidMount() {
    ...
    gsap.timeline()
      .from(this.castle[0], {duration: 3, translateY: 800})
      .from(this.castle[1], {duration: 3,translateY: 800}, "<")
      .from(this.castle[2], {duration: 3,translateY: 800}, "<")
      .from(this.windows[1], {duration: 3,translateY: 800}, "<")
  
      .from(this.castle[3], {duration: 3,translateY: 800}, "-=2")
      .from(this.castle[4], {duration: 3,translateY: 800}, "<")
      .from(this.castle[5], {duration: 3,translateY: 800}, "<")
      .from(this.castle[6], {duration: 3,translateY: 800}, "<")
      .from(this.castle[7], {duration: 3,translateY: 800}, "<")
      .from(this.castle[8], {duration: 3,translateY: 800}, "<")
      .from(this.windows[0], {duration: 3,translateY: 800}, "<")
  
      .from(this.cloud[1], {duration: 2, translateX: 2000, alpha: 0}, "-=2")
      .from(this.cloud[0], {duration: 2, translateX: -2000, alpha: 0}, "-=2.5")
  
      .from(this.three[0], {duration: 2, translateY: 400, rotate: -25}, '-=1')
      .from(this.three[1], {duration: 2, translateY: 400, translateX: 200, rotate: -25}, "<")
      .from(this.three[2], {duration: 2, translateY: 400, translateX: 200, rotate: 25}, "<")
      .from(this.three[3], {duration: 2, translateY: 400, translateX: 200, rotate: 25}, "<")
      .from(this.three[4], {duration: 2, translateY: 400, translateX: 200, rotate: 25}, "<")
  
      .from(this.moon[2], {duration: 3,translateX: 1000, translateY: -100,alpha: 0}, "-=.5")
      .from(this.moon[3], {duration: 3,translateX: 1000, translateY: -100,alpha: 0}, "-=2.94")
      .from(this.moon[4], {duration: 3,translateX: 1010, translateY: -200,alpha: 0, scale: .9}, "<")
      .from(this.moon[5], {duration: 3,translateX: 1000, translateY: -100,alpha: 0}, "<")
      .from(this.moon[6], {duration: 3,translateX: 1000, translateY: -200,alpha: 0, scale: .9}, "<")
