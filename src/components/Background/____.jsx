      ...
      <div className="wrapper-background">
        ...
        >
          <defs>
            ...
            >
              <stop stop-color="#ffffc7" offset="0" />
              <stop stop-color="#ffffdc" stop-opacity=".63" offset=".36" />
              <stop stop-color="#fffff5" stop-opacity=".18" offset=".8" />
            ...
            <linearGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
              <stop stop-color="#2a3050" offset="0" />
              <stop stop-color="#4c5893" offset="1" />
            </linearGradient>
            <linearGradient
              ...
              gradientUnits="userSpaceOnUse"
            >
              <stop stop-color="#1d1d36" offset="0" />
              <stop stop-color="#2c346d" offset="1" />
            </linearGradient>
            <linearGradient
            ...
            />
            {/* <style>
              .prefix__cls-3{{ fill: "#222328" }}.prefix__cls-4
              {{ fill: "#11110f" }}.prefix__cls-8{{ fill: "#ffffc7" }}
              .prefix__cls-10{{ fill: "#e5e09f" }}
            </style> */}
          </defs>
